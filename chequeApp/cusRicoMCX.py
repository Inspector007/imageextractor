...
def analysisData():
	if os.path.isdir('/home/puneet/Desktop/deepak/Projects/mysite/document/output') == True:
		shutil.rmtree('/home/puneet/Desktop/deepak/Projects/mysite/document/output/')
	lstdate = mmyydd()
	fileName1 = ''
	fileName2 = ''	
	for i in glob.glob('/home/puneet/Desktop/deepak/Projects/mysite/document/ucc/%s/%s/%s/*' %(lstdate[1],lstdate[0],lstdate[2])):
		fileName1 = i.split('/')[-1]
		print fileName1
	...
	exchangeF = '/home/puneet/Desktop/deepak/Projects/mysite/document/ucc/%s/%s/%s/%s' %(lstdate[1],lstdate[0],lstdate[2],fileName1)
	backOff = '/home/puneet/Desktop/deepak/Projects/mysite/document/bo/%s/%s/%s/%s' %(lstdate[1],lstdate[0],lstdate[2],fileName2)
	...
	#mobile 
	mcount1 = 0
	mc1= "MCX Dummy updated and Back office Blank"
	mcount2 = 0
	mc2 = "MCX Dummy updated and Back offfice other number"
	mcount3 = 0
	mc3 = "MCX Dummy updated and Back offfice has Same number"
	mcount4 = 0
	mc4 = "MCX UCC Blank and Back Office Blank"
	mcount5 = 0
	mc5 = "MCX UCC Blank and Back Office has Other number"
	mcount6 = 0
	mc6 = "MCX UCC Blank and Back Office has Dummy"
	mcount7 = 0
	mc7 = "MCX UCC has Correct number and Back office has Blank"
	mcount8 = 0
	mc8 = "MCX UCC has Correct number and Back office has Dummy"
	mcount9 = 0
	mc9 = "MCX UCC and Back Office has different Number"
	mcount10 = 0
	mc10 = "MCX UCC has Incorrect number  and back office has same"
	mcount11 = 0
	mc11 = "MCX UCC has Incorrect number  and back office has Blank"
	mcount12 = 0
	mc12 = "MCX UCC has Incorrect number  and back office has correct number"

	#Email

	emcount1 = 0
	emc1 = "MCX Dummy updated and Back office Blank"
	emcount2 = 0
	emc2 = "MCX Dummy updated and Back offfice other number"
	emcount3 = 0
	emc3 = "MCX Dummy updated and Back offfice has Same number"
	emcount4 = 0
	emc4 = "MCX UCC Blank and Back Office Blank"
	emcount5 = 0
	emc5 = "MCX UCC Blank and Back Office has Other number"
	emcount6 = 0
	emc6 = "MCX UCC Blank and Back Office has Dummy"
	emcount7 = 0
	emc7 = "MCX UCC has Correct number and Back office has Blank"
	emcount8 = 0
	emc8 = "MCX UCC has Correct number and Back office has Dummy"
	emcount9 = 0
	emc9 = "MCX UCC and Back Office has different Number"
	emcount10 = 0
	emc10 = "MCX UCC And Back Office has blank Numbar and blank Email"
	...
	with open (exchangeF,'r') as f1:
		...
		for i in f1:
			...
			listM.append(x)
			tlist.append(x)
			x = il[3].strip().lower() #pan -2 -- 3  
			tlist.append(x)
			x = il[9].strip().lower()# 4 Email -- 9
			tlist.append(x)
			x = il[24].strip()# 3 mobile -- 24 
			tlist.append(x)
			#fdict[tlist[0]] = tlist
			count += 1
			if count < 30:
	...
	os.mkdir('/home/puneet/Desktop/deepak/Projects/mysite/document/output/')

	outf = '/home/puneet/Desktop/deepak/Projects/mysite/document/output/'

	with open(outf+'duplicateWithMCX.csv','w') as f11:
...
#print  '\n', len(fdict) ,'\n'  
	...
	with open(outf+'mismatchWithMCX.csv','w') as f11:
	...
	finaloutput = open(outf + "MCXfinalCount%s-2.csv" %time.time(), mode="w")
	...
	while i < f:
    		if i == 0:
			csvwrite.writerow([""])
			csvwrite.writerow(["MCX UCC  Moble Reco","Total","Active in Back office","De-active in Back Office"])
        		csvwrite.writerow([""])
    	#print l[i]
    		if i == 12:
			csvwrite.writerow([""])
        		csvwrite.writerow(["MCX UCC  Email Reco","Total","Active in Back office","De-active in Back Office"])
        		csvwrite.writerow([""])
	...
	finaloutput1 = open(outf + "BackOfficeExtraMCX.csv", mode="w")
